      ...
      >
            ...
            >
              ...
              <button
                ...
                style={{
                  ...
                  alignItems: "center",
                  gap: "9px",
                  padding: (isAttractMode) ? "22px 44px" : (hideRecentre ? "11px 22px" : "11px 24px 11px 20px"),
                  borderRadius: "999px",
                  border: "none",
                  background: "linear-gradient(180deg, rgba(135, 185, 64, 0.85) 0%, rgba(115, 160, 50, 0.85) 100%)",
                  color: "#ffffff",
                  fontSize: isAttractMode ? "1.92rem" : "1.24rem",
                  fontWeight: 700,
                  cursor: "pointer",
        ...
        <div
          ...
          style={{
            ...
            background: "linear-gradient(155deg, rgba(18, 18, 22, 0.97) 0%, rgba(10, 10, 12, 0.95) 52%, rgba(18, 18, 22, 0.96) 100%)",
            boxShadow: "0 42px 120px rgba(0, 0, 0, 0.65), 0 16px 34px rgba(0, 0, 0, 0.45), inset 0 1px 0 rgba(255, 255, 255, 0.12)",
            backdropFilter: "none",
            WebkitBackdropFilter: "none",
            borderRadius: "32px",
              ...
              <div style={{
                ...
                <div
                  style={{
                    ...
                    overflowY: "auto",
                    overflowX: "hidden",
                    padding: "4.2rem 2.2rem 2rem 2.2rem",
                    gap: "1.8rem",
                    scrollbarWidth: "none",
                  }}
                >
                      ...
                      <div style={{ position: "relative" }}>
                        <div
                          style={{
                            ...
                            bottom: "8px",
                            width: "24px",
                            background: "linear-gradient(90deg, rgba(2,6,23,0.5) 0%, rgba(2,6,23,0) 100%)",
                            pointerEvents: "none",
                            zIndex: 2,
                          }}
                        />
                        <div
                          style={{
                            ...
                            bottom: "8px",
                            width: "24px",
                            background: "linear-gradient(270deg, rgba(2,6,23,0.5) 0%, rgba(2,6,23,0) 100%)",
                            pointerEvents: "none",
                            zIndex: 2,
                          }}
                        />
                          ...
                          {galleryItems.map((item, index) => (
                            ...
                            >
                              ...
                              >
                                ...
                                />
                                {item.type === "video" ? (
                                  <div style={{ position: "absolute", inset: 0, borderRadius: "inherit", background: "linear-gradient(180deg, transparent 40%, rgba(0,0,0,0.45) 100%)", display: "flex", alignItems: "center", justifyContent: "center" }}>
                                    <div style={{ width: "38px", height: "38px", borderRadius: "50%", background: "rgba(255,255,255,0.92)", backdropFilter: "blur(8px)", display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 4px 16px rgba(0,0,0,0.3)" }}>
                                      <svg width="14" height="14" viewBox="0 0 24 24" fill="#c4302b" style={{ marginLeft: "2px" }}>
                              ...
                              <div
                                style={{
                                  fontSize: "0.82rem",
                                  fontWeight: 600,
                                  color: index === galleryActiveIndex ? "rgba(255,255,255,0.95)" : "rgba(255,255,255,0.65)",
                                  lineHeight: 1.35,
                                  display: "-webkit-box",
                                  WebkitLineClamp: 2,
                                  WebkitBoxOrient: "vertical",
                            ...
                            {galleryItems.map((item, index) => (
                              <button
                                ...
                                onClick={(e) => {
                                  ...
                                  if (galleryTrackRef.current && galleryTrackRef.current.children[index]) {
                  ...
                  {/* Overview Card */}
                  <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem", ...getRevealStyle(4) }}>
                    <div
                      style={{
        ...
        {lightboxItem ? (
          <div
            ...
            className="lightbox-overlay-animate"
            style={{
              position: "fixed",
              inset: 0,
          ...
          >
            <div
              onClick={(event) => event.stopPropagation()}
              className="lightbox-outer-row lightbox-modal-animate"
              style={{
                position: "relative",
            ...
            >
              ...
              >
                {/* 1. Header: Country Badge + Video Title (Above Video Player) */}
                <div style={{ display: "flex", flexDirection: "column", gap: "0.6rem", flexShrink: 0, paddingRight: "3rem" }}>
                  {selectedCountry ? (
                    <div style={{
                      display: "inline-flex",
                      alignItems: "center",
                ...
                {/* 3. Description & Credit Line (Under Player, Above Gallery) */}
                <div
                  style={{
                    background: "linear-gradient(135deg, rgba(255, 255, 255, 0.04) 0%, rgba(255, 255, 255, 0.015) 100%)",
                    border: "1px solid rgba(255, 255, 255, 0.08)",
