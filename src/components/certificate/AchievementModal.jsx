        ...
        >
          {walletQrUrl ? (
            <div style={{
              ...
              <div style={{ marginTop: "0.35rem", fontSize: "0.62rem", color: "#999", fontWeight: 400, lineHeight: 1.2, textAlign: "center", maxWidth: "220px", opacity: 0.75 }}>
                Experimental feature provided by walletwallet.dev. Device support may vary.
              </div>
            </div>
          ) : (
            <>
